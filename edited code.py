...
FPS = 15
WINDOWWIDTH = 990      #changed to fullscreen
WINDOWHEIGHT = 990
CELLSIZE = 30
...
RED       = (255,   0,   0)
BLUE = (100,149,237)
GREEN = (202,255,112)           #Added a green variable
...
def drawAntiApple(coord):
    x = coord['x'] * CELLSIZE
    y = coord['y'] * CELLSIZE
    AntiAppleRect = pygame.Rect(x, y, CELLSIZE, CELLSIZE)
    pygame.draw.rect(DISPLAYSURF, BLACK, AntiAppleRect)
